...
import "./Header.css";
import logo from "../../Assets/khelkud.png";
      ...
      <div className="Header__topbar flex space__between" style={{ padding: "10px 20px" }}>
        ...
        <div className="rightOptions flex align__items__center" style={{ justifyContent: "flex-end", gap: "20px" }}>
          ...
          <Link to="/favourites" className="icon relative" style={{ margin: "0 15px" }}>
            ...
            <span className="badge" style={{ position: "absolute", top: "-10px", right: "-10px", backgroundColor: "#95C730", color: "#fff", borderRadius: "50%", width: "16px", height: "16px", display: "flex", alignItems: "center", justifyContent: "center" }}>
